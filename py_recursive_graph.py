...
def main():
    ...
    print("Initializing connections to devices in new inventory file...")
    nr, results = init_nornir(username, password)
    ...
    ### CREATE SITE ID DICTIONARIES ###
    tmp_dict_output = build_sites(results, nr)
    rec_host_dict = rebuild_inventory(results, tmp_dict_output, nr)
    ...
    inv_final = {**rec_host_dict, **inv_dict}
